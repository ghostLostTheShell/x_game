extends TextureRect
@onready var enable_texture = preload("res://mission_manager/texture/任务1-已领取.png")
@onready var unenable_texture = preload("res://mission_manager/texture/任务1.png")
...
func _on_receive_button_pressed() -> void:
	if 1 in Global.CompletedTasks:
		...
		Global.CompletedTasks.append(1)
		texture = enable_texture
		receive_button.texture_normal = button_unenable_texture
