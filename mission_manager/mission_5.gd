extends TextureRect
@onready var enable_texture = preload("res://mission_manager/texture/任务5-已领取.png")
@onready var unenable_texture = preload("res://mission_manager/texture/任务5.png")
...
func _on_receive_button_pressed() -> void:
	if 5 in Global.CompletedTasks:
		...
		Global.CompletedTasks.append(5)
		texture = enable_texture
		receive_button.texture_normal = button_unenable_texture
